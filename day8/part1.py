    ...
    for r2 in range(len(arr)):
        for c2 in range(len(arr[0])):
            ...
            if arr[r2][c2] == curr_antinode:
                total += drawAntinodeOffsets((r, c), (r2, c2))
    return total
